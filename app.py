        ...
        if results:
            ...
            for idx, r in df_sorted.iterrows():
                try:
                    ...
                    valuation_insight = "potentially overvalued as price above graham value and number" if (gn_val and gv_val and current_price > gn_val and current_price > gv_val) else "potentially undervalued as price below graham value and number" else "mixed valuation: price is above the Graham Number but below the Graham Value"
    if (gn_val and gv_val and current_price > gn_val and current_price < gv_val) else "mixed valuation: price is below the Graham Number but above the Graham Value"
    if (gn_val and gv_val and current_price < gn_val and current_price > gv_val)
    else  "Graham valuation metrics not available"
